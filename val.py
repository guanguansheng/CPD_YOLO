...
def save_one_json(predn, jdict, path, class_map):
    ...
    image_id = int(path.stem[:4]) if path.stem.isnumeric() else path.stem
...
def run(
    ...
    if save_json and len(jdict):
        ...
        anno_json = str(Path("test.json"))  # annotations
...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/ip22.yaml", help="dataset.yaml path")
